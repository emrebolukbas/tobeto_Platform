...
class Test_tobetoWelcomePanel():
    ...
    def test_successful_filter(self):
        ...
        teacher = WebDriverWait(self.driver,2).until(ec.visibility_of_element_located((By.XPATH,"//*[@id='collapseOne']/div/ul/li[7]/a")))
        assert teacher.text == "Gürkan İlişen"
        self.driver.find_element(By.TAG_NAME, 'body').send_keys(Keys.PAGE_DOWN)
        sleep(1)
        chooseteacher = WebDriverWait(self.driver,5).until(ec.visibility_of_element_located((By.XPATH,"//div[@id='collapseOne']/div/ul/li[7]/a/input")))
        chooseteacher.click()
        sleep(1)
